...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        {
            CustomRoles.Crewmate.ToString(), CustomRoles.Engineer.ToString(), CustomRoles.Survivor.ToString(), CustomRoles.Amnesiac.ToString(), CustomRoles.Reviver.ToString(),
        };
        public static readonly CustomRoles[] CRoleGuardianAngelChangeRoles =
        {
            CustomRoles.Crewmate, CustomRoles.Engineer, CustomRoles.Survivor, CustomRoles.Amnesiac, CustomRoles.Reviver,
        };

        //Lawyer Changes Roles
        public static readonly string[] LWChangeRoles =
        {
            CustomRoles.Crewmate.ToString(), CustomRoles.Opportunist.ToString(), CustomRoles.MadSnitch.ToString(), CustomRoles.Snitch.ToString(),CustomRoles.Magician.ToString(),
        };
        public static readonly CustomRoles[] CRoleLawyerChangeRoles =
        {
             CustomRoles.Crewmate, CustomRoles.Opportunist, CustomRoles.MadSnitch, CustomRoles.Snitch, CustomRoles.Magician,
        };
        public static readonly string[] LW1ChangeRoles =
        {
            CustomRoles.Crewmate.ToString(), CustomRoles.Mayor.ToString(), CustomRoles.Flash.ToString(), CustomRoles.TieBreaker.ToString(),
        };
        public static readonly CustomRoles[] CRolecheatersChangeRoles =
        {
             CustomRoles.Crewmate, CustomRoles.Mayor, CustomRoles.Flash, CustomRoles.TieBreaker,
        };
        ...
        public static CustomOption MedicTaskCompletedBatteryCharge;
        public static CustomOption ParamedicTaskCompletedBatteryCharge;
        ...
        public static CustomOption draculaCooldown;
        public static CustomOption draculaDelay;
        public static CustomOption draculaBuff;
        public static CustomOption HustlerCooldown;
        public static CustomOption vampCooldown;
        ...
        public static CustomOption ReviverArrow;
        ...
        //WIZARD//
        public static CustomOption WizardDuration;
        public static CustomOption WizardCooldown;

        //Pumpkins//
        public static CustomOption PUMPkinsPotionDuration;
        public static CustomOption PUMPkinsPotionCooldown;
        ...
        public static CustomOption WhenLawyerTargetDies;
        public static CustomOption WhencheatersTargetDies;
        // OTHER STUFF //
        ...
        public static void Load()
        {
            ...
            vampCooldown = CustomOption.Create(50714, Color.white, "VampireCooldown", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.Vampire]);
            ...
            SetupRoleOptions(20094334, CustomRoles.Pickpocket, AmongUsExtensions.OptionType.Impostor);
           ...
           // SetupRoleOptions(7008531, CustomRoles.Forecaster, AmongUsExtensions.OptionType.Crewmate);
            ...
            //Lawyer
            SetupSingleRoleOptions(190500, CustomRoles.Lawyer, 1, AmongUsExtensions.OptionType.Neutral);
            LawyerknowsRole = CustomOption.Create(190513, Color.white, "LWKR", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            TargetKnowsLawyer = CustomOption.Create(190514, Color.white, "TKLW", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            WhenLawyerTargetDies = CustomOption.Create(190515, Color.white, "WhenLWdies", AmongUsExtensions.OptionType.Neutral, LWChangeRoles, LWChangeRoles[1], CustomRoleSpawnChances[CustomRoles.Lawyer]);
            SetupRoleOptions(200943341, CustomRoles.Hustler, AmongUsExtensions.OptionType.Impostor);
            //Paramedic
            SetupRoleOptions(700859, CustomRoles.Paramedic, AmongUsExtensions.OptionType.Crewmate);
            ParamedicTaskCompletedBatteryCharge = CustomOption.Create(20725, Color.white, "ParamedicTaskCompletedBatteryCharge", AmongUsExtensions.OptionType.Crewmate, 5, 0, 10, 1, CustomRoleSpawnChances[CustomRoles.Medic]);
           ...
           /* SetupRoleOptions(1214002, CustomRoles.Crusader, AmongUsExtensions.OptionType.Crewmate);
            ...
            SetupSingleRoleOptions(50713, CustomRoles.Dracula, 1, AmongUsExtensions.OptionType.Neutral);
            draculaCooldown = CustomOption.Create(50714, Color.white, "DraculaCooldown", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.Dracula]);
            draculaDelay = CustomOption.Create(50715, Color.white, "DraculaDelay", AmongUsExtensions.OptionType.Neutral, 5, 1, 1000, 1, CustomRoleSpawnChances[CustomRoles.Dracula]);
            draculaBuff = CustomOption.Create(1311, Color.white, "DraculaDelayBuff", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Dracula]);

            SetupRoleOptions(2050001, CustomRoles.Magician, AmongUsExtensions.OptionType.Neutral);
            MagicianTasks = OverrideTasksData.Create(101211, CustomRoles.Magician, AmongUsExtensions.OptionType.Neutral);

            SetupSingleRoleOptions(9050031, CustomRoles.Reviver, 1, AmongUsExtensions.OptionType.Crewmate);
            ReviverArrow = CustomOption.Create(60000201, Color.white, "ReviverHasArrow", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Reviver]);
           // SetupSingleRoleOptions(9050034, CustomRoles.Satan, 1, AmongUsExtensions.OptionType.Neutral);
           // SetupSingleRoleOptions(9050035, CustomRoles.Chancer, 1, AmongUsExtensions.OptionType.Crewmate);
           // SetupSingleRoleOptions(9050036, CustomRoles.Sellout, 1, AmongUsExtensions.OptionType.Neutral);


            SetupSingleRoleOptions(26009, CustomRoles.Wizard, 1, AmongUsExtensions.OptionType.Impostor);
            WizardDuration = CustomOption.Create(2600109, Color.white, "WizardDuration", AmongUsExtensions.OptionType.Impostor, 30f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.Wizard]);
            WizardCooldown = CustomOption.Create(2600119, Color.white, "WizardCooldown", AmongUsExtensions.OptionType.Impostor, 15f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.Wizard]);
            ...
            CrewRolesVetted = CustomOption.Create(20014, Color.white, "CRGV", AmongUsExtensions.OptionType.Crewmate, true, CustomRoleSpawnChances[CustomRoles.Veteran]);
            PestiAttacksVet = CustomOption.Create(20015, Color.white, "PestiAttacks", AmongUsExtensions.OptionType.Crewmate, PestiAttacksVetString, PestiAttacksVetString[2], CustomRoleSpawnChances[CustomRoles.Veteran]);
            SetupSingleRoleOptions(26001, CustomRoles.PUMPkinsPotion, 1, AmongUsExtensions.OptionType.Impostor);
            PUMPkinsPotionDuration = CustomOption.Create(2600103, Color.white, "PUMPkinsPotionDuration", AmongUsExtensions.OptionType.Impostor, 30f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.PUMPkinsPotion]);
            PUMPkinsPotionCooldown = CustomOption.Create(2600113, Color.white, "PUMPkinsPotionCooldown", AmongUsExtensions.OptionType.Impostor, 15f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.PUMPkinsPotion]);
            //EvilWatcherChance = CustomOption.Create(30010, Color.white, "EvilWatcherChance", 0, 0, 100, 10, CustomRoleSpawnChances[CustomRoles.Watcher]);
            ...
            EnableHiddenRoles = CustomOption.Create(100610, Color.yellow, "EnableHiddenRoles", AmongUsExtensions.OptionType.GameOption, true, null, true)
                .SetGameMode(CustomGameMode.Standard);
            NameDisplayAddons = CustomOption.Create(1006046, Color.red, "NameDisplayAddons", AmongUsExtensions.OptionType.GameOption, true)
                .SetGameMode(CustomGameMode.All);
            ...
            AddedTheAirShip = CustomOption.Create(100404, Color.white, "AddedTheAirShip", AmongUsExtensions.OptionType.GameOption, false, RandomMapsMode)
                .SetGameMode(CustomGameMode.All);
            AddedThefungle = CustomOption.Create(100404, Color.white, "AddedThefungle", AmongUsExtensions.OptionType.GameOption, false, RandomMapsMode)
                .SetGameMode(CustomGameMode.All);
