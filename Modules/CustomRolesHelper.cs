...
namespace TownOfHost
{
    static class CustomRolesHelper
    {
        ...
        public static bool UsesVents(this CustomRoles role) //vents
        {
            return
                role is CustomRoles.Jester or
                CustomRoles.Terrorist or
        ...
        public static bool IsCrewmate(this CustomRoles role) => !role.IsImpostorTeam() && !role.IsNeutral() && !role.IsCoven() || role == CustomRoles.Chancer || role == CustomRoles.Sellout || role == CustomRoles.Satan;
        ...
        public static bool Canbeseen(this CustomRoles role)
        {
            return
                role is CustomRoles.Kamikaze;
        }
        public static bool Crewguessed(this CustomRoles role)
        {
            return
                role is CustomRoles.Snitch or
                CustomRoles.Sheriff or
