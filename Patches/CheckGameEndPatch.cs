    ...
    class CheckGameEndPatch
    {
        public static bool Prefix(LogicGameFlowNormal __instance)
        {
            ...
            if (Main.currentWinner == CustomWinner.Default)
            {
                ...
                else
                {
                    ...
                    if (CheckAndEndGameForPoisonerWin(instance, statistics)) return false;
                    if (CheckAndEndGameForMagicianWin(instance, statistics)) return false;
                    if (CheckAndEndGameForHustlerWin(instance, statistics)) return false;
        ...
        private static bool CheckAndEndGameForImpostorWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamImpostorsAlive >= statistics.TotalAlive - statistics.TeamImpostorsAlive &&
                statistics.TeamJackalAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
        ...
        private static bool CheckAndEndGameForJackalWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamJackalAlive >= statistics.TotalAlive - statistics.TeamJackalAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
        ...
        {
            if (statistics.TeamImpostorsAlive == 0 && statistics.TeamKnightAlive == 0 && statistics.TeamJackalAlive == 0 && statistics.TeamJuggernautAlive == 0 && statistics.TeamHustlerAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamCovenAlive == 0 && statistics.TeamPestiAlive == 0 && statistics.TeamGlitchAlive == 0 && statistics.TeamWolfAlive == 0 && statistics.TeamArsoAlive == 0 && statistics.TeamMarksAlive == 0 && statistics.TeamAgiAlive == 0)
            {
                __instance.enabled = false;
        ...
        private static bool CheckAndEndGameForCovenWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamCovenAlive >= statistics.TotalAlive - statistics.TeamCovenAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamArsoAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
        ...
        private static bool CheckAndEndGameForKnighthWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamKnightAlive >= statistics.TotalAlive - statistics.TeamKnightAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamArsoAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
        ...
        private static bool CheckAndEndGameForArsonist(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamArsoAlive >= statistics.TotalAlive - statistics.TeamArsoAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
        ...
        private static bool CheckAndEndGameForMarksman(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamMarksAlive >= statistics.TotalAlive - statistics.TeamMarksAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamAgiAlive <= 0
        ...
        private static bool CheckAndEndGameForAgitater(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamAgiAlive >= statistics.TotalAlive - statistics.TeamAgiAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamHustlerAlive <= 0 && statistics.sheriffAlive <= 0 && statistics.TeamMagicAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
        ...
        private static void ResetRoleAndEndGame(GameOverReason reason, bool showAd)
        {
            ...
            foreach (var pc in PlayerControl.AllPlayerControls)
            {
                ...
                if (pc.Is(CustomRoles.Sheriff) || pc.Is(CustomRoles.Investigator) || pc.Is(CustomRoles.Janitor) || pc.Is(CustomRoles.Escort) || pc.Is(CustomRoles.Crusader) ||
                    (!(Main.currentWinner == CustomWinner.Arsonist) && pc.Is(CustomRoles.Arsonist)) || (Main.currentWinner == CustomWinner.Lovers && !Main.LoversPlayers.Contains(pc)) || (pc.Is(CustomRoles.Satan)) || (pc.Is(CustomRoles.Hitman) && pc.Data.IsDead) || (Main.currentWinner != CustomWinner.Vulture && pc.Is(CustomRoles.Vulture)) || (Main.currentWinner != CustomWinner.Painter && pc.Is(CustomRoles.Painter)) || (Main.currentWinner != CustomWinner.Marksman && pc.Is(CustomRoles.Marksman)) || (Main.currentWinner != CustomWinner.Pirate && pc.Is(CustomRoles.Pirate)) ||
                    ...
                    LoseImpostorRole || (Main.currentWinner != CustomWinner.Werewolf && pc.Is(CustomRoles.Werewolf)) || (Main.currentWinner != CustomWinner.TheGlitch && pc.Is(CustomRoles.TheGlitch)) || (Main.currentWinner != CustomWinner.Dracula && pc.Is(CustomRoles.Dracula)) || (Main.currentWinner != CustomWinner.Magician && pc.Is(CustomRoles.Magician)) || (Main.currentWinner != CustomWinner.Hustler && pc.Is(CustomRoles.Hustler)))
                {
        ...
        public class PlayerStatistics
        {
            ...
            public int TeamMagicAlive { get; set; }
            ...
            private void GetPlayerCounts()
            {
                ...
                for (int i = 0; i < GameData.Instance.PlayerCount; i++)
                {
                    ...
                    if (!playerInfo.Disconnected)
                    {
                        if (!playerInfo.IsDead)
                        {
                            ...
                            playerInfo.GetCustomRole() != CustomRoles.Juggernaut || playerInfo.GetCustomRole() != CustomRoles.Dracula ||
                             playerInfo.GetCustomRole() != CustomRoles.Werewolf || playerInfo.GetCustomRole() != CustomRoles.Magician ||
                            !playerInfo.GetCustomRole().IsCoven() || playerInfo.GetCustomRole() != CustomRoles.Investigator || playerInfo.GetCustomRole() != CustomRoles.Hustler
                            ...
                            || playerInfo.GetCustomRole() != CustomRoles.Crusader || playerInfo.GetCustomRole() != CustomRoles.Satan || playerInfo.GetCustomRole() != CustomRoles.Hitman
                            ...
                            else if (playerInfo.GetCustomRole() == CustomRoles.Dracula) dracula++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Magician) Magician++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Hustler) Hustler++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Sheriff) sheriff++;
                ...
                TeamPoisonerAlive = dracula;
                TeamMagicAlive = Magician;
                TeamHustlerAlive = Hustler;
                sheriffAlive = sheriff;
