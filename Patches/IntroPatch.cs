...
namespace TownOfHost
{
    ...
    class BeginCrewmatePatch
    {
        public static void Prefix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> teamToDisplay)
        {
            ...
            {
                var lwTeam = new Il2CppSystem.Collections.Generic.List<PlayerControl>();
                lwTeam.Add(PlayerControl.LocalPlayer);
                foreach (var lwId in Main.LawyerTarget)
                {
                    PlayerControl lawyering = Utils.GetPlayerById(lwId.Value);
                    lwTeam.Add(lawyering);
                }
                teamToDisplay = lwTeam;
            }
        }
        public static void Postfix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> teamToDisplay)
        {
            ...
            {
                __instance.TeamTitle.text = "Town Of Chaos: \r\nThe Other Roles";
                __instance.ImpostorText.gameObject.SetActive(true);
