...
namespace TownOfHost
{
    ...
    class CanUseVentPatch
    {
            ...
            ref float __result)
        {
            ...
            else if (pc.Object.Is(CustomRoles.Sheriff) || pc.Object.Data.IsImpostor() && GameOptionsManager.Instance.CurrentGameOptions.GameMode == GameModes.HideNSeek || pc.Object.Is(CustomRoles.AgiTater) || pc.Object.Is(CustomRoles.PlagueBearer) || pc.Object.Is(CustomRoles.PoisonMaster) || pc.Object.Is(CustomRoles.Amnesiac) || pc.Object.Is(CustomRoles.Reviver) || pc.Object.Is(CustomRoles.Escort) || pc.Object.Is(CustomRoles.Crusader) || pc.Object.Is(CustomRoles.Janitor) || pc.Object.Is(CustomRoles.Investigator) || (pc.Object.Is(CustomRoles.Arsonist) && !pc.Object.IsDouseDone() && !Options.TOuRArso.GetBool()))
                return false;
