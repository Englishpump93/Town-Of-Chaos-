...
namespace TownOfHost
{
    ...
    class ControllerManagerUpdatePatch
    {
        ...
        public static void Postfix(ControllerManager __instance)
        {
            ...
            if (AmongUsClient.Instance.AmHost)
            {
                ...
                if (Input.GetKeyDown(KeyCode.Q) && GameStates.IsCountDown)
                {
    ...
    class HandleHUDPatch
    {
        public static void Postfix(Rewired.Player player)
        {
            ...
            (PlayerControl.LocalPlayer.Is(CustomRoles.Juggernaut) && Options.JuggerCanVent.GetBool()) || PlayerControl.LocalPlayer.Is(CustomRoles.Hustler) || PlayerControl.LocalPlayer.Is(CustomRoles.Dracula) || PlayerControl.LocalPlayer.Is(CustomRoles.TheGlitch)
