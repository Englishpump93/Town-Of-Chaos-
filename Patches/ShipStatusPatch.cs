    ...
    class RepairSystemPatch
    {
            ...
            [HarmonyArgument(2)] byte amount)
        {
            ...
            if (systemType == SystemTypes.Sabotage)
            {
                ...
                }, Kamikaze.KamiNameCooldownAfterLights.GetFloat(), "Mare Red Name Cooldown (After Lights)");
            }
            return true;
        }
