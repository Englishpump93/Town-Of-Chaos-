            ...
            if (SetHudActivePatch.IsActive && player.IsAlive())
            {
                switch (player.GetCustomRole())
                {
                    ...
                    case CustomRoles.Reviver:
                        __instance.ReportButton.OverrideText($"TRADE");
                        break;
                    ...
                    case CustomRoles.Hustler:
                        __instance.KillButton.OverrideText($"Hustle");
                        __instance.ReportButton.OverrideText($"REPORT");
                        break;
                }
                ...
                else if (player.Is(CustomRoles.Wizard))
                {
                    var ModeLang = Main.IsInviswizard ? "Yes" : "No";
                    var ReadyLang = Main.CanGoInviswizard ? "Yes" : "No";
                    LowerInfoText.text = "Is Invisible: " + ModeLang;
                    LowerInfoText.text += "\nCan Use Abracadabra: " + ReadyLang;
                    LowerInfoText.enabled = true;
                }
                else if (player.Is(CustomRoles.PUMPkinsPotion))
                {
                    var ModeLang = Main.IsInvispumpkin ? "Yes" : "No";
                    var ReadyLang = Main.CanGoInvispumpkin ? "Yes" : "No";
                    LowerInfoText.text = "Is PUMPkined: " + ModeLang;
                    LowerInfoText.text += "\nCan Use Potion: " + ReadyLang;
                    LowerInfoText.enabled = true;
                }
