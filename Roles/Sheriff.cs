...
namespace TownOfHost
{
    public static class Sheriff
    {
        ...
        private static CustomOption CanKillLawyer;
        private static CustomOption CanKillDemon;
        ...
        public static void SetupCustomOption()
        {
            ...
            CanKillLawyer = CustomOption.Create(Id + 30, Color.white, "SheriffCanKillLawyer", AmongUsExtensions.OptionType.Crewmate, true, Options.CustomRoleSpawnChances[CustomRoles.Sheriff]);
            ...
            CanKillDemon = CustomOption.Create(Id + 39, Color.white, "SheriffCanKillDemon", AmongUsExtensions.OptionType.Crewmate, true, Options.CustomRoleSpawnChances[CustomRoles.Sheriff]);
        ...
        public static bool CanBeKilledBySheriff(this PlayerControl player)
        {
            ...
            return cRole switch
            {
                ...
                CustomRoles.Satan => CanKillDemon.GetBool(),
                ...
                CustomRoles.Dracula => CanKillJackal.GetBool(),
                CustomRoles.Hustler => CanKillJackal.GetBool(),
